...
# 모델들 설정
MODEL_NAME_TEXT_GEN = "gpt-3.5-turbo" # 문장 생성 LLM 모델 이름 (원본 : gpt-3.5-turbo)
...
MODEL_NAME_TARGET = "phi3" # 목표 모델 이름 (원본 : 논문에선 Llama-3 8B, Claude-3.5 Sonnet, GPT-4o 등등)
...
class ModelHuggingFace:
    def __init__(self, model_name):
        ...
        self.tokenizer.chat_template = "default"
    
    def get_response(self, prompt, max_n_tokens, temperature):
        # chat_template을 사용하는 대신 직접 프롬프트 포맷
